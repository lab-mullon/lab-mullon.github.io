...
for (time in seq(1,TF)) {
  ...
  print(paste0("Gen:", time, " - Pop. size: ", length(pop.xi), " - Mean number of mutations: ", mean(count(pop.xi))))
...
hist(count(pop.xi), ylab="Distribution", xlab = "Mean number of mutations", 
     main="Distribution of mutations at final time")
