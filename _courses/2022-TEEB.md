                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="excerpt" style="text-align:left;margin-top:0px;margin-bottom:0px;">
                            <a target="_blank" href="/docs/TEEB/{{ session.paper_file }}"><i class="fa fa-file-text" aria-hidden="true"></i></a> <b>{{ session.paper_author }}, {{ session.paper_year }}</b>: {{ session.paper_title }}.  
                        </div>
                    </div>
                </div>
            </div>
