            ...
            <div class="p-4 border rounded">
                <div class="row">
                    ...
                    <div class="col-md-9">
	                    ...
	                    <small class="d-inline-block mt-1 mb-3 font-weight-normal" style="color:#006400" style="margin-bottom:0px;">{{ session.date }}</small>
                        <div class="excerpt" style="margin-top:0px;margin-bottom:0px;">
                            <b>{{ session.paper_author }} ({{ session.paper_year }})</b>: {{ session.paper_title }} <a target="_blank" href="/docs/TEEB/{{ session.paper_file }}"><i class="fa fa-file-text" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
